...
namespace DadVSMe
{
    public static class DOFade
    {
        ...
        public static async UniTask FadeInAsync(float duration = GameDefine.DEFAULT_FADE_DURATION)
        {
            ...
            await GameInstance.FadeImage.DOFade(1f, duration).SetEase(Ease.OutCubic).SetUpdate(UpdateType.Normal, true);
        }
        ...
        public static async UniTask FadeOutAsync(float duration = GameDefine.DEFAULT_FADE_DURATION)
        {
            ...
            await GameInstance.FadeImage.DOFade(0f, duration).SetEase(Ease.InCubic).SetUpdate(UpdateType.Normal, true);
